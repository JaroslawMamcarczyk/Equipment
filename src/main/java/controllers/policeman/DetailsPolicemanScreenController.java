...
public class DetailsPolicemanScreenController {
    ...
    private Rank newWorkerRanks = null;
    private Department newPolicemanDepartament = null;
    ...
    private  ObservableList<Rank> ranksObservableList = FXCollections.observableArrayList();
